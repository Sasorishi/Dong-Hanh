 ...
 */
final class Version20241024234521 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE logistic_information CHANGE arrival_datetime arrival_datetime DATE NOT NULL, CHANGE departure_datetime departure_datetime DATE NOT NULL');
    }
}
