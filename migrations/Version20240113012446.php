 ...
 */
final class Version20240113012446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_97A0ADA3212C041E ON ticket');
        $this->addSql('ALTER TABLE ticket CHANGE id_event_id event_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE event_id id_event_id INT NOT NULL');
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA3212C041E FOREIGN KEY (id_event_id) REFERENCES event (id)');
        $this->addSql('CREATE INDEX IDX_97A0ADA3212C041E ON ticket (id_event_id)');
    }
}
