...
const StepperComponent = ({ currentStep, isOnline }) => {
  const stepperEvent = (currentStep) => {
    return (
      <div>
  ...
  const stepperOnlineEvent = (currentStep) => {
    return (
      <div>
        <ol className="flex items-center w-full">
          <li
  ...
  return (
    <>
      {isOnline ? stepperOnlineEvent(currentStep) : stepperEvent(currentStep)}
    </>
  );
};
